...
assert_contains "$MONITOR_SKILL" "count % 4 == 3" "Monitor skill documents Occam selector branch"
...
assert_contains "$CGCR_DOC" "count % 4" "CGCR doc documents modulo prompt selector"
